...
# Module-level convenience functions for testing and UI integration
...
def waveform_to_signal(y_pixels: np.ndarray, mV_per_pixel: float) -> np.ndarray:
    """Convert pixel coordinates to mV signal."""
